# Migrating Expo UI to Prabath Kumara Design System

Read `artifacts/prabath-kumara/docs/AGENTS.md` and
`artifacts/prabath-kumara/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/prabath-kumara/lib/native-theme` and
  `@workspace/prabath-kumara/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/prabath-kumara/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/prabath-kumara` and retains only
