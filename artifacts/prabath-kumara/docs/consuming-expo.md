# Consuming Prabath Kumara Design System in Expo apps

Read `artifacts/prabath-kumara/docs/AGENTS.md` first. React Native does
...
`artifacts/prabath-kumara/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/prabath-kumara/tokens";
...
```tsx
import { nativeTheme } from "@workspace/prabath-kumara/lib/native-theme";
import { useColors } from "@workspace/prabath-kumara/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/prabath-kumara/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/prabath-kumara/components/native/badge";
import { Button } from "@workspace/prabath-kumara/components/native/button";
import { Card } from "@workspace/prabath-kumara/components/native/card";
```
...
Import and render
`@workspace/prabath-kumara/components/native/button`, then run Expo
