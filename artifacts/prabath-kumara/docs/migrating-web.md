# Migrating web UI to Prabath Kumara Design System

Read `artifacts/prabath-kumara/docs/AGENTS.md` and
`artifacts/prabath-kumara/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/prabath-kumara/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/prabath-kumara/lib/utils`
- `@/hooks/use-toast` → `@workspace/prabath-kumara/hooks/use-toast`
