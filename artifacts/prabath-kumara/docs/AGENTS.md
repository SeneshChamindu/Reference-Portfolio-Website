# Prabath Kumara Design System design system
...
workspace package (`@workspace/prabath-kumara`): other artifacts depend
...
- `SKILL.md` — source-derived usage guidance for the dark cinematic portfolio
  language.
- `docs/references/` — retained logo and home-screen evidence extracted from the
  Reference Portfolio Website.
...
`@workspace/prabath-kumara/components/...`. Never use a `@/` alias inside
...
for `@workspace/prabath-kumara` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/prabath-kumara` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/prabath-kumara/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/prabath-kumara/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/prabath-kumara/docs/consuming-slides.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/prabath-kumara/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/prabath-kumara/docs/migrating-expo.md`
